...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run the clinical AI evaluation suite.")
    parser.add_argument("--full", action="store_true", help="Run evaluation on the full dataset.")
    args = parser.parse_args()

    limit = None if args.full else 2
    logging.info(f"Loading data... (limit: {'full dataset' if limit is None else limit})")
